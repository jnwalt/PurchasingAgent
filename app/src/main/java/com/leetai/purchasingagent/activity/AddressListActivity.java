...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tools.initTitleView(AddressListActivity.this, getWindow(), R.string.title_activity_address_list, R.string.title_activity_address_list_add, listener, true);
        getList();
    }
...
//                        }
                        ...
                        for (int d = 0; d < list_address.size(); d++) {
                            ...
                            map.put("cb_default", list_address.get(d).getDefaultadd());
                            listmap.add(map);
                        }
